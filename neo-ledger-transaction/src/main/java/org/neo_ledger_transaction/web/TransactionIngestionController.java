...
public class TransactionIngestionController {
  ...
  public TransactionIngestionController(IngestionUseCasePort ingestionUseCasePort) {
  ...
  public ResponseEntity<String> ingestPaymentFile(@RequestBody String paymentFile)
      throws XMLStreamException, IOException, ParserConfigurationException {
    InputStream inputStream =
        new ByteArrayInputStream(paymentFile.getBytes(StandardCharsets.UTF_8));
