 ...
 *
 * <p>This interface provides a mechanism to validate an XML stream against a specific schema (XSD)
 * and to determine a validator's compatibility with a given format.
 */
public interface XmlValidator {
   ...
   * @throws ValidationException If the XML document does not conform to the schema or if an error
