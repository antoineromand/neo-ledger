 ...
 *
 * <p>It leverages Spring's dependency injection to collect all available validator beans and
 * selects the one that matches the requested format via the {@code supports} method.
 */
@Component
