 ...
 *
 * <p>This class loads official XSD schemas for PAIN.008 (Direct Debit) and PAIN.001 (Credit
 * Transfer) messages to ensure the structural compliance of processed files.
 */
@Component
public class XsdSepaValidator implements XmlValidator {
  ...
  /**
   * Constructor initializing the supported SEPA schemas. * @throws SAXException If an error occurs
   * during the loading or compilation of the XSD files.
   */
  public XsdSepaValidator() throws SAXException {
    SchemaFactory factory = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
    this.schemas = new HashMap<>();
    this.schemas.put(
        "SEPA_PAIN_008", factory.newSchema(getClass().getResource("/xsd/pain.008.001.11.xsd")));
    this.schemas.put(
        "SEPA_PAIN_001", factory.newSchema(getClass().getResource("/xsd/pain.001.001.03.xsd")));
  }
  ...
  /**
   * Indicates whether the format is handled by this SEPA validator. * @param format The format
   * identifier.
   *
