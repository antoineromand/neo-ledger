...
public class IngestionServiceRollbackIntTest extends AbstractPostgresContainer {
  ...
  @Autowired private IngestionUseCasePort ingestionUseCasePort;

  @Autowired private TransactionOutboxJpaRepository transactionOutboxJpaRepository;

  @Autowired private JdbcTemplate jdbcTemplate;

  @MockitoSpyBean private TransactionOutboxRepositoryAdapter transactionOutboxRepositoryAdapter;
  ...
  void should_rollback_all_outbox_entries_when_second_save_fails() throws Exception {
    ...
    try (InputStream inputStream = getClass().getResourceAsStream("/pain001_1776420067.xml")) {
      ...
      assertThrows(
          ApplicationException.class, () -> ingestionUseCasePort.executeIngestion(inputStream));
    }
